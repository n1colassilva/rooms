let field = {
	...
	draw: {
		...
		square: function (char, startPoint, endPoint) {
			...
			field.draw.line(char, startPoint, topRightPoint); // Top side
			field.draw.line(char, topRightPoint, endPoint); // Right side
			field.draw.line(char, endPoint, bottomLeftPoint); // Bottom side
			field.draw.line(char, bottomLeftPoint, startPoint); // Left side
		},
